...
bool Core::hlt(Uart *u) {
    return dap_wr32(u, 0xE000EDF0, 0xA05F0003);
}

bool Core::run(Uart *u) {
    return dap_wr32(u, 0xE000EDF0, 0xA05F0000);
}

bool Core::wr32(Uart *u, uint32_t a, uint32_t v) { return dap_wr32(u, a, v); }
bool Core::rd32(Uart *u, uint32_t a, uint32_t &v) { return dap_rd32(u, a, v); }
